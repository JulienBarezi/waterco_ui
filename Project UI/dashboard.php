...
<div class="tab-content" id="myTabContent">
  ...
  <div class="tab-pane fade show active" id="member" role="tabpanel" aria-labelledby="member-tab">
  	...
  	<div class="tab-content" id="nav-tabContent">
		<div class="tab-pane add-form fade show active" id="addm" role="tabpanel" aria-labelledby="addm-tab">
			<div class="row">
			<form action="contact.php" method="POST" class="form section-form" onsubmit="event.preventDefault(); onFormSubmit();">
				<h1 class="add-title">Add/update a member</h1>
			...
			<table class="table" id="members_list">
			  <thead>
			    <tr>
  ...
  <div class="tab-pane fade" id="premise" role="tabpanel" aria-labelledby="premise-tab">
  	...
  	<div class="tab-content" id="nav-ptabContent">
		<div class="tab-pane add-form fade show active" id="addp" role="tabpanel" aria-labelledby="addp-tab">
			<div class="row">
			<form action="contact.php" method="POST" class="form section-form" onsubmit="event.preventDefault(); onFormSubmitP();">
				<h1 class="add-title">Add/Update a premise</h1>
				<div class="input-main">
				...
				<div class="input">
			    	...
			    	<input type="text" id="meter_number" name="meter_number" placeholder="meter_number" required="">
			    </div>
			...
			<table class="table" id="premises_list">
			  <thead>
			    <tr>
				  ...
				  <th scope="col" class="align-middle">Meter Number</th>
			      <th scope="col" class="align-middle">Options</th>
			    </tr>
			  </thead>
			  <tbody>
  ...
  <div class="tab-pane fade" id="bill" role="tabpanel" aria-labelledby="bill-tab">
  	...
  	<div class="tab-content" id="nav-billtabContent">
		<div class="tab-pane add-form fade show active" id="addb" role="tabpanel" aria-labelledby="addb-tab">
			<div class="row">
			<form action="contact.php" method="POST" class="form section-form" onsubmit="event.preventDefault(); onFormSubmitB();">
				<h1 class="add-title">Add/update bill</h1>
				<div class="input-main">
			...
			<table class="table" id="bills_list">
			  <thead>
			    <tr>
  ...
  <div class="tab-pane fade" id="payment" role="tabpanel" aria-labelledby="payment-tab">
  	...
  	<div class="tab-content" id="nav-paymenttabContent">
		<div class="tab-pane add-form fade show active" id="addpay" role="tabpanel" aria-labelledby="addpay-tab">
			<div class="row">
			<form action="contact.php" method="POST" class="form section-form" onsubmit="event.preventDefault(); onFormSubmitPay();">
				<h1 class="add-title">Add/update a Payment</h1>
				<div class="input-main">
			...
			<table class="table" id="payments_list">
			  <thead>
			    <tr>
 ...
 <div class="tab-pane fade" id="route" role="tabpanel" aria-labelledby="route-tab">
 	...
 	<div class="tab-content" id="nav-routetabContent">
		<div class="tab-pane add-form fade show active" id="addr" role="tabpanel" aria-labelledby="addr-tab">
			<div class="row">
			<form action="contact.php" method="POST" class="form section-form" onsubmit="event.preventDefault(); onFormSubmitR();">>
			...
			<table class="table" id="routes_list">
			  <thead>
			    <tr>
			      <th scope="col" class="align-middle">Route ID</th>
 ...
 <div class="tab-pane fade" id="staff" role="tabpanel" aria-labelledby="staff-tab">
  	<div class="staff">
			...
			<table class="table" id="staffs_list">	
			  <thead>
			    <tr>
			      <th scope="col" class="align-middle">Full Name</th>
			      <th scope="col" class="align-middle">Staff ID</th>
		      ...
		      <div class="modal-header">
		        ...
		        <form action="contact.php" method="POST" class="modal-body" >
					...
					<div class="input">
				    	...
				    	<input type="text" id="full_name" name="full_name" placeholder="Name..." required="" autocomplete="off">
					</div>

			    <div class="input">
			    	<label for="useremail">Email</label>
			    	<input type="email_address" id="email_address" name="email_address" placeholder="Email..." required="" autocomplete="off">
			    </div>
